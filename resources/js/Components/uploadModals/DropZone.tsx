...
export function DropZone({ selectedFiles, uploadType }: PropsType) {
    ...
    const labelClassNames = useMemo(() => clsx("flex flex-col items-center justify-center w-full h-32 rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 border-2 border-gray-300 border-dashed", { "border-3 border-gray-600": isDragOver }), [isDragOver])

    const inputProps = uploadType === "folders" ? {
        directory: "",
        mozdirectory: "",
        webkitdirectory: ""
    } : { multiple: true }
