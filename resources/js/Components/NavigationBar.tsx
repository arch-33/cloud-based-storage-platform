                    ...
                    user ? <ProfileDropDown user={user} /> : (
                        <>
                            {links.includes("login") &&
                                <NavbarItem>
                                    <Button variant="light" color="primary" className="font-medium" as={Link} href={route('login')}>Log In</Button>
                                </NavbarItem>
                            }

                            {links.includes("login") && links.includes("register") && <Divider orientation="vertical" className="h-1/2" />}

                            {links.includes("register") &&
                                <NavbarItem>
                                    <Button variant="light" color="primary" className="font-medium" as={Link} href={route('register')}>Create Account</Button>
                                </NavbarItem>
                            }
                        </>
                    )
